...
#              'plot_types'         : ['free_surface','flowrate']}
    ...
    custom = {'user_case_name'     : 'flow_over_a_bump_0032_T20_R', 
              'txtout_directory'   : 'outtxt_bump_0032_T20_R',
              'binsave_directory'  : 'outbin_bump_0032_T20_R',
    ...
    custom = {'user_case_name'     : 'flow_over_a_bump_0064_T20_R', 
              'txtout_directory'   : 'outtxt_bump_0064_T20_R',
              'binsave_directory'  : 'outbin_bump_0064_T20_R',
    ...
    #--------------------------------------------------------------------------
    # new setup
    custom = {'user_case_name'     : 'flow_over_a_bump_0128_T20_R', 
              'txtout_directory'   : 'outtxt_bump_0128_T20_R',
              'binsave_directory'  : 'outbin_bump_0128_T20_R',
    ...
    #--------------------------------------------------------------------------
    # new setup
    custom = {'user_case_name'     : 'flow_over_a_bump_0256_T20_R', 
              'txtout_directory'   : 'outtxt_bump_0256_T20_R',
              'binsave_directory'  : 'outbin_bump_0256_T20_R',
    ...
    #--------------------------------------------------------------------------
    # new setup
    custom = {'user_case_name'     : 'flow_over_a_bump_0512_T20_R', 
              'txtout_directory'   : 'outtxt_bump_0512_T20_R',
              'binsave_directory'  : 'outbin_bump_0512_T20_R',
