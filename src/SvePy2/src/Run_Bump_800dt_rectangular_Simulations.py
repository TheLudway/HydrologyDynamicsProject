...
#              'plot_types'         : ['free_surface','flowrate']}
    ...
    custom = {'user_case_name'     : 'flow_over_a_bump_0800aR', 
              'txtout_directory'   : 'outtxt_bump_0800aR',
              'binsave_directory'  : 'outbin_bump_0800aR',
              'flow_over_a_bump_NX': 800,
              'heightBC': 0.262,
              'time_total': 400,
