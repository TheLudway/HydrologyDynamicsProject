...
Using 128 grid cells (64 in domain)
...
#              'plot_types'         : ['free_surface','flowrate']}
    ...
    custom = {'user_case_name'     : 'flow_over_a_bump_0128aR', 
              'txtout_directory'   : 'outtxt_bump_0128aR',
              'binsave_directory'  : 'outbin_bump_0128aR',
    ...
    #--------------------------------------------------------------------------
    # new setup
    custom = {'user_case_name'     : 'flow_over_a_bump_0128bR', 
              'txtout_directory'   : 'outtxt_bump_0128bR',
              'binsave_directory'  : 'outbin_bump_128bR',
              'flow_over_a_bump_NX': 128,
              'heightBC': 0.262,
              'time_total': 400,
              'plot_time_interval' : 4,
    ...
    custom = {'user_case_name'     : 'flow_over_a_bump_0128cR', 
              'txtout_directory'   : 'outtxt_bump_0128cR',
              'binsave_directory'  : 'outbin_bump_0128cR',
              'flow_over_a_bump_NX': 128,
              'heightBC': 0.262,
              'time_total': 400,
              'plot_time_interval' : 4,
    ...
    custom = {'user_case_name'     : 'flow_over_a_bump_0128dR', 
              'txtout_directory'   : 'outtxt_bump_0128dR',
              'binsave_directory'  : 'outbin_bump_0128dR',
              'flow_over_a_bump_NX': 128,
              'heightBC': 0.262,
              'time_total': 400,
              'plot_time_interval' : 4,
