...
#              'plot_types'         : ['free_surface','flowrate']}
    ...
    custom = {'user_case_name'     : 'flow_over_a_bump_1024_linear_and_simplejump', 
              'txtout_directory'   : 'outtxt_bump_1024_linear_and_simplejump',
              'binsave_directory'  : 'outbin_bump_1024_linear_and_simplejump',
