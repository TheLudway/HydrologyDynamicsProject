...
#              'plot_types'         : ['free_surface','flowrate']}
    ...
    custom = {'user_case_name'     : 'flow_over_a_bump_0400aR', 
              'txtout_directory'   : 'outtxt_bump_0400aR',
              'binsave_directory'  : 'outbin_bump_0400aR',
              'flow_over_a_bump_NX': 400,
              'heightBC': 0.262,
              'time_total': 400,
...
#    #--------------------------------------------------------------------------
#    # new setup
#    custom = {'user_case_name'     : 'flow_over_a_bump_0340bR', 
#              'txtout_directory'   : 'outtxt_bump_0340bR',
#              'binsave_directory'  : 'outbin_bump_0340bR',
#              'flow_over_a_bump_NX': 340,
#              'heightBC': 0.262,
#              'time_total': 400,
#              'plot_time_interval' : 4,
#              'print_time_header_step_interval':100,
...
#    # new setup
#
#    custom = {'user_case_name'     : 'flow_over_a_bump_0340cR', 
#              'txtout_directory'   : 'outtxt_bump_0340cR',
#              'binsave_directory'  : 'outbin_bump_0340cR',
#              'flow_over_a_bump_NX': 340,
#              'heightBC': 0.262,
#              'time_total': 400,
#              'plot_time_interval' : 4,
...
#    # new setup
#
#    custom = {'user_case_name'     : 'flow_over_a_bump_0340dR', 
#              'txtout_directory'   : 'outtxt_bump_0340dR',
#              'binsave_directory'  : 'outbin_bump_0340dR',
#              'flow_over_a_bump_NX': 340,
#              'heightBC': 0.262,
#              'time_total': 400,
#              'plot_time_interval' : 4,
