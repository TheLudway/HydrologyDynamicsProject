...
#              'plot_types'         : ['free_surface','flowrate']}
    ...
    custom = {'user_case_name'     : 'flow_over_a_bump_0064aR', 
              'txtout_directory'   : 'outtxt_bump_0064aR',
              'binsave_directory'  : 'outbin_bump_0064aR',
    ...
    #--------------------------------------------------------------------------
    # new setup
    custom = {'user_case_name'     : 'flow_over_a_bump_0064bR', 
              'txtout_directory'   : 'outtxt_bump_0064bR',
              'binsave_directory'  : 'outbin_bump_0064bR',
              'flow_over_a_bump_NX': 64,
              'heightBC': 0.262,
              'time_total': 400,
              'plot_time_interval' : 4,
    ...
    custom = {'user_case_name'     : 'flow_over_a_bump_0064cR', 
              'txtout_directory'   : 'outtxt_bump_0064cR',
              'binsave_directory'  : 'outbin_bump_0064cR',
              'flow_over_a_bump_NX': 64,
              'heightBC': 0.262,
              'time_total': 400,
              'plot_time_interval' : 4,
    ...
    custom = {'user_case_name'     : 'flow_over_a_bump_0064dR', 
              'txtout_directory'   : 'outtxt_bump_0064dR',
              'binsave_directory'  : 'outbin_bump_0064dR',
              'flow_over_a_bump_NX': 64,
              'heightBC': 0.262,
              'time_total': 400,
              'plot_time_interval' : 4,
