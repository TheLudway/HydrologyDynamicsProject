...
#              'plot_types'         : ['free_surface','flowrate']}
    ...
    custom = {'user_case_name'     : 'flow_over_a_bump_0256_linear_and_simplejump', 
              'txtout_directory'   : 'outtxt_bump_0256_linear_and_simplejump',
              'binsave_directory'  : 'outbin_bump_0256_linear_and_simplejump',
