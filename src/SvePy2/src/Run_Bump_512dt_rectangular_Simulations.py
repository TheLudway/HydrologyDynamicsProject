...
Using 512 grid cells (256 in domain)
...
#              'plot_types'         : ['free_surface','flowrate']}
    ...
    custom = {'user_case_name'     : 'flow_over_a_bump_0512aR', 
              'txtout_directory'   : 'outtxt_bump_0512aR',
              'binsave_directory'  : 'outbin_bump_0512aR',
    ...
    #--------------------------------------------------------------------------
    # new setup
    custom = {'user_case_name'     : 'flow_over_a_bump_0512bR', 
              'txtout_directory'   : 'outtxt_bump_0512bR',
              'binsave_directory'  : 'outbin_bump_0512bR',
              'flow_over_a_bump_NX': 512,
              'heightBC': 0.262,
              'time_total': 400,
              'plot_time_interval' : 4,
    ...
    custom = {'user_case_name'     : 'flow_over_a_bump_0512cR', 
              'txtout_directory'   : 'outtxt_bump_0512cR',
              'binsave_directory'  : 'outbin_bump_0512cR',
              'flow_over_a_bump_NX': 512,
              'heightBC': 0.262,
              'time_total': 400,
              'plot_time_interval' : 4,
    ...
    custom = {'user_case_name'     : 'flow_over_a_bump_0512dR', 
              'txtout_directory'   : 'outtxt_bump_0512dR',
              'binsave_directory'  : 'outbin_bump_0512dR',
              'flow_over_a_bump_NX': 512,
              'steps_max': 150000,
              'heightBC': 0.262,
              'time_total': 400,
